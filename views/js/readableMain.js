...
function updatePositions() {
  ...
  var j = 0; //i % 5 will always be equal to 0, 1, 2, 3, or 4. j is a counter to remove the modulo math
  var items = document.getElementsByClassName('mover');
  for (var i = 0; i < items.length; i++) {
    if (j >= 5) { //makes sure that j is never equal to 5 or more.
      j = 0;
    }
    var phase = Math.sin(moveTop + j);
