...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
    ...
    /* Optimised:
     This function iterates through pizza elements on the page and changes their widths.
     Moved DOM reference out of the for loop and replaced querySelectorAll with getElementsByClassName
     to improve performance.
     Consolidated the work of functions determineDx and sizeSwitcher into changePizzaSizes function and
     removed extra/unnecessary logic to determine newdiwth of pizza.
    */
...
function updatePositions() {
  ...
  /* Optimisation:
    DOM reference is moved outside the for loop
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /* Reduced the number of pizzas from 200 to 24.
     Setting the elements left property here as it was causing a
     lot of performance bottleneck when done in updatePositions while scrolling */
  for (var i = 0; i < 24; i++) {
  ...
  // Added requestAnimationFrame to improve performance
  window.requestAnimationFrame(updatePositions);
});
