...
*/
    ...
    var resizePizzas = function (size) {
        ...
        function changeSliderLabel(size) {
            switch (size) {
                ...
                case "3":
                    ...
                    return;
                default:
                    console.warn("bug in changeSliderLabel");
            }
        }
            ...
            function sizeSwitcher(size) {
                switch (size) {
                    ...
                    case "3":
                        return 0.5;
                    default:
                        console.warn("bug in sizeSwitcher");
                }
            }
        ...
        // CHANGE: use clone to avoid excessive layout changes
        // CHANGE: determine size outside the loop, since they are all the same size
        // CHANGE: use getElementById instead of querySelector
        ...
        function changePizzaSizes(size) {
            ...
            for (var i = 0; i < pizzas.length; i++) {
                pizzas[i].style.width = (pizzas[i].offsetWidth + dx) + 'px';
            }
    ...
    // CHANGE: clone and do a single update to avoid excessive layout
    ...
    function updatePositions() {
        ...
        var parentDiv = document.getElementById("movingPizzas1");
        var pizzaClone = parentDiv.cloneNode(true);
        var items = pizzaClone.getElementsByClassName('mover');
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (itemTop <= viewBottom && itemTop + items[i].height >= 0) {
                items[i].style.left = parseInt(items[i].getAttribute('basicleft')) + 100 * phase + 'px';
            }
        }

        parentDiv.parentNode.replaceChild(pizzaClone, parentDiv);
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        for (var i = 0; i < 200; i++) {
            ...
            elem.setAttribute('basicleft', ((i % cols) * s).toString());
