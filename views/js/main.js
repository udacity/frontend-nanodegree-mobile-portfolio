...
var adjectives = ["dark", "color", "whimsical", "shiny", "noise", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    resizePizzas = function(e) {
        ...
        function r(e, a) {
            ...
            //change querySelector for getElementById and remove #
            var n = e.offsetWidth,
        ...
        function n(e) {
            //declare variable randomPizzas, no repeat yourself
            //change querySelectorAll for getElementsByClassName and remove .
...
window.addEventListener("scroll", updatePositions), document.addEventListener("DOMContentLoaded", function() {
    for (r = 0; e * f > r; r++) {
        ...
        n.className = "mover", n.src = "images/pizza.png", n.style.height = "100px", n.style.width = "73.333px", n.basicLeft = r % e * a, n.style.top = Math.floor(r / e) * a + "px", movingPizzas1.appendChild(n)
    }
    updatePositions()
});