...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var changedWidth; // create variable used to update pizza width
    switch(size) {
      case "1":
        changedWidth = 25;
        break;
    ...
    pizzaSizeChange[i].style.width = changedWidth + '%'; // avoid FSL
    }
  }
...
var pizzasDiv = document.getElementById("randomPizzas"); // moved var declaration out of the loop
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'); // Replaced "querySelectorAll"

  // Set an array to avoid calculating at each step, and moved phase calculation out of the loop
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Reduced the amount of moving pizzas
  for (var i = 0; i < 35; i++) {
