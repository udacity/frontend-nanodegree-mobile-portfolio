...
var resizePizzas = function (size) {
    ...
    // CHANGE: apply size to randomPizzaContainer class style rather than individual pizzas
    // CHANGE: use getElementById instead of querySelector
    // Changes size of random pizzas
    function changePizzaSizes(size) {
        var pizza = document.getElementById('pizza0');
